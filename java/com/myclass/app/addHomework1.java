...
public class addHomework1 extends Fragment {

    EditText hwName, hwDes, hwAttachment, hwDate;
    Spinner sHW;
    Button addHW;
    ...
    String hwNameInput, hwDesInput,hwDateInput, sHWInput;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_add_homework1, container, false);
        //sHW = view.findViewById(R.id.sHW);
        hwName = view.findViewById(R.id.hwName);
        hwDes = view.findViewById(R.id.hwDes);
        hwAttachment = view.findViewById(R.id.hwFile);
        hwDate = view.findViewById(R.id.hwDate);
        addHW = view.findViewById(R.id.addHw);
        ...
        addHW.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (CheckAllFields()) {
                    uploadPDF(displayName,pdfPath,Id);
                }
            }
        });
          /* sHW.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                sHWInput = classesArrayList.get(position).getC_id();
            }
        ...
        hwDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(getActivity(),
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year,
                                ...
                                hwDate.setText(dayOfMonth + "-" + (monthOfYear + 1) + "-" + year);
                            }
                        }, mYear, mMonth, mDay);
            ...
            if (uriString.startsWith("content://")) {
                ...
                try {
                    ...
                    if (cursor != null && cursor.moveToFirst()) {
                        ...
                        hwAttachment.setText(displayName);
                    }
                } finally {
                    cursor.close();
                }
    ...
    private boolean CheckAllFields() {
        ...
        if (hwName.length() == 0) {
            hwName.setError("Please enter name");
            return false;
        }
        if (hwDes.length() == 0) {
            hwDes.setError("Please enter des");
            return false;
        }
        if (hwAttachment.length() == 0) {
            hwAttachment.setError("Please enter attachment");
            return false;
        }
        if (hwDate.length() == 0) {
            hwDate.setError("Please enter due date");
            return false;
        }
        return true;
    }
...
//        pd.show();
            ...
            public void onResponse(String response) {
                try {
                   ...
                   /* for (int j = 0; j < classesArrayList.size(); j++) {
                    ...
                    sHW.setAdapter(spinnerArrayAdapter);*/
    ...
    private void uploadPDF(final String pdfname, Uri pdffile,String id){
        pd.setTitle("");
        pd.setMessage("Loading...");
        pd.show();
        ...
        try {
            ...
            VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, URLs.URL_addHomeWork,
                    new Response.Listener<NetworkResponse>() {
                        ...
                        public void onResponse(NetworkResponse response) {
                            ...
                            try {
                                ...
                                if (message.equals("Homework Added Successfuly")) {
                                    Toast.makeText(getActivity(), "Home work added", Toast.LENGTH_SHORT).show();
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    Map<String, String> data = new HashMap<>();
                    hwNameInput = hwName.getText().toString();
                    hwDesInput = hwDes.getText().toString();
                    hwDateInput = hwDate.getText().toString();

                    data.put("name", hwNameInput);
                    data.put("des", hwDesInput);
                    data.put("date", hwDateInput);
                    data.put("c_id", id);
